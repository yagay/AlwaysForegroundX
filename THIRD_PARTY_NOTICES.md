...
No floating-window implementation source code from those projects is incorporated into the MiniWindowGuard 4.1 window engine. The current implementation was rewritten for this project around Android system concepts including VirtualDisplay, SurfaceView, ActivityTaskManager and InputManager.
